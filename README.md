...
<div align="center">
  ...
  *Transforming data into actionable insights, one project at a time*
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=20&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=435&lines=Data+Analyst+%26+ML+Engineer;Python+%7C+Streamlit+%7C+Django;ETL+%7C+SQL+%7C+Data+Viz;Building+the+future+of+data!)
...
```yaml
Compétences:
  Data_Analysis: ["Python", "Pandas", "NumPy", "SQL", "Excel"]
  Machine_Learning: ["Scikit-learn", "NLTK", "Model Training", "Feature Engineering"]
  Data_Visualization: ["Plotly", "Matplotlib", "Seaborn", "Streamlit"]
  Web_Development: ["Django", "HTML/CSS", "JavaScript", "Tailwind CSS"]
  Data_Engineering: ["ETL Processes", "SQL Databases", "Data Pipelines"]
  
Roadmap_2024_2025:
  DevOps: ["Docker", "CI/CD", "Git Advanced"]
  Cloud: ["AWS/Azure", "Cloud Databases", "Data Lakes"]
  Big_Data: ["Apache Airflow", "Apache Spark", "Kafka"]
```
...
![Jimmy's GitHub Stats](https://github-readme-stats.vercel.app/api?username=ThePerformer0&show_icons=true&theme=tokyonight&hide_border=true&count_private=true)

</td>
<td width="50%">

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=ThePerformer0&layout=compact&theme=tokyonight&hide_border=true)

</td>
</tr>
</table>

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=ThePerformer0&theme=tokyonight&hide_border=true)
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/ThePerformer0)
